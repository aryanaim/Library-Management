...
def add_book(): #add books
    conn=mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor=conn.cursor()
    ...
    sql = 'insert into book(title,author,price,pages,publisher,edition,status) values ( "' + title + '","' + author + '",' + price + ',' + pages + ',"' + publisher + '","' + edition + '","available");'
...
def modify_member(): #modify members
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
    clear()
...
def mem_issue_status(mem_id): #see memeber issue status
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def book_status(book_id): #see book status
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def book_issue_status(book_id, mem_id): #see book issue status
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def issue_book(): #issue book to member
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
    ...
    if len(result1) == 0:
        if result == 'available':
            ...
            print('Book is not available for issue, current status :', result)
    else:
        if len(result1) < 1:
...
def return_book(): #return book from member
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
    global fine_per_day
    clear()
...
def search_book(field): #search for book
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def search_menu(): #book search menu
    while True:
        clear()
        print(' SEARCH MENU ')
        print("\n1. Book Title")
...
def report_book_list(): #report of books
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_issued_books(): #report of isuued books in list format
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_available_books(): #report of available books
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_weed_out_books(): #report of weed out books
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_stolen_books(): #report of stolen books
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_lost_books(): #report of lost books
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_member_list(): #report of all members
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def report_fine_collection(): #report of total fine collection
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
...
def change_book_status(status, book_id): #modify book status
    conn = mysql.connector.connect(host='localhost', database='library', user='root', password='slugterra')
    cursor = conn.cursor()
